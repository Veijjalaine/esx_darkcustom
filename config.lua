...
Config.Menus = {
	...
	modEngine = {
		...
		parent = 'upgrades',
		modType = 11,
		price = {14.95, 33.56, 66.12, 149.53}
	},
	modBrakes = {
		label = _U('brakes'),
		parent = 'upgrades',
		modType = 12,
		price = {6.65, 9.7, 19.6, 14.95}
	},
	modTransmission = {
		label = _U('transmission'),
		parent = 'upgrades',
		modType = 13,
		price = {14.95, 21.93, 47.51}
	},
	modSuspension = {
		label = _U('suspension'),
		parent = 'upgrades',
		modType = 15,
		price = {4.72, 7.94, 14.98, 31.77, 42.2}
	},
	modArmor = {
		label = _U('armor'),
		parent = 'upgrades',
		modType = 16,
		price = {72.77, 124.28, 133.20, 153.21, 181.23, 192.10}
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
